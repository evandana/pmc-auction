        ...
        return (
            <form onSubmit={handleSubmit} className="auction-form">
                ...
                <div>
                    ...
                    <TextField
                        id="openingBid" hintText="0" {...openingBid}/>
                </div>
                <div>
                ...
                <div>
                    ...
                    <TextField
                        id="donorName" {...donorName}/>
                </div>
                <div>
                    <label>Expiration</label>
                    <TextField
                        id="expiration" hintText="09/2016" {...expiration}/>
                </div>
                <div>
                    <label>Show immediately?</label>
                    <TextField
                        id="showImmediately" hintText="true | false" {...show}/>
                </div>
                <div>
