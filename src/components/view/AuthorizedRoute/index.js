...
class AuthorizedRoute extends Component {
    ...
    render() {
        ...
        // if on mobile and not chrome
        const unsupportedBrowser = !isChrome && isMobile;

        return (
            <Route {...rest} render={props => (
                userPermissions.basic || userPermissions.admin || userPermissions.seller ? (
                        <div className='page-wrapper' style={pageWrapperStyles}>
                            {!unsupportedBrowser || this.state.hideUnsupportedBrowserText ? '' : (
                                <Paper
                                    style={{
                                        width: '100%',
                                      }}
                                    ...
                                    <div
                                        ...
                                        style={{padding:'1em'}}
                                        >
                                        This may be an unsupported browser on a mobile device.
                                        <br/>
                                        Please open this link in Chrome: <a href="https://pmc-2018.firebaseapp.com">pmc-2018.firebaseapp.com</a>
                                    </div>
                                    <RaisedButton
                                        className="col-xs-4"
                                        onClick={() => this.setState({hideUnsupportedBrowserText: true})}
                                        icon={<CloseIcon />}
                                        />
                                </Paper>
                            )}
